...
function keyPressed() {
	...
	//select code to applyForce to ball

	//Matter.applyForce(ball,ball.position,{x:130,y:-145});

	Matter.Body.applyForce(ball,ball.position,{x:130,y:-145});

	//Matter.Body.Force(ball,ball.position,{x:130,y:-145});

	//Matter.Body.(ball,ball.position,{x:130,y:-145});
